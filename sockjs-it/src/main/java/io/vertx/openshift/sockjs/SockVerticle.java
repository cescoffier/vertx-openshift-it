...
public class SockVerticle extends AbstractVerticle {
  ...
  public static final String TO_CLIENT = "to.client";
  public static final String TO_SERVER = "to.server";
  public static final BridgeOptions PERMITTED_OPTIONS = new BridgeOptions()
  ...
  public void start() throws Exception {
    ...
    vertx.eventBus().consumer(TO_SERVER, (content) -> {
      status.put(content.body().toString() + "-EB", true);
    });
