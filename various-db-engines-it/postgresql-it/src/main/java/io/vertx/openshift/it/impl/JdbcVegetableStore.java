...
public class JdbcVegetableStore implements DataStore {
  private static final String INSERT = "INSERT INTO vegetables (name, amount) VALUES (?, ?::BIGINT)";
  ...
  private static final String UPDATE = "UPDATE vegetables SET name = ?, amount = ?::BIGINT WHERE id = ?";
