 ...
 */
public class MapsIT extends AbstractTestClass {

  private static final String APPLICATION_NAME = "cluster-maps";

  private static Route route;
  private static OpenShiftHelper clusterMapsHelper;
